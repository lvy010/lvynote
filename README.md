...
- RedInk: 基于Gemini+Nano Banana Pro的小红书AI图文生成器，==一句话+一张图片生成完整6-9页小红书图文==，支持智能大纲、风格学习和批量生成，Flask后端+Vue3前端架构_12.18 
...
- Box64:  Linux用户态x86_64模拟器，在ARM64/RISC-V等非x86架构上运行x86_64 Linux程序，支持动态库翻译、JIT编译和系统调用转换，为==跨架构软件兼容提供高性能解决方案==_12.16
